...
A.eq(plan.summary.districts, 9, 'default city has nine major districts including Impact');
A.eq(plan.summary.buildings, 13, 'default city stamps thirteen first-wave buildings');
