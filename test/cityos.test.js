...
A.eq(plan.summary.districts, 10, 'default app city has ten districts including Financial');
A.eq(plan.summary.buildings, 19, 'default app city has nineteen buildings including six Financial buildings');
