---
name: Code Foundry
slug: line-code-foundry
description: Build code, review it, and iterate with bounded passes while routing non-code work elsewhere.
...
## Pattern
A classifier sends code to ENGINEER and other work to GENERALIST. Code then passes independent REVIEWER verdicts, with three passes maximum.

## Roles
ENGINEER, REVIEWER, GENERALIST.
