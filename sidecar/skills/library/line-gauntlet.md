...
name: Gauntlet Line
slug: line-gauntlet
description: Run two independent attempts, synthesize them, and hold the result behind bounded review.
...
## Pattern
Two workers make independent attempts; ANALYST reconciles them; REVIEWER approves or returns corrections for no more than three passes.

## Roles
WORKER-A, WORKER-B, ANALYST, REVIEWER.
