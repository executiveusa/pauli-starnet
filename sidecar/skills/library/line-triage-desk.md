---
name: Triage Desk
slug: line-triage-desk
description: Route code, research, and general work to the right specialist and collect one internal result.
...
## Pattern
Classify once, route to ENGINEER, RESEARCHER, or GENERALIST, then collect without changing each branch result.

## Roles
ENGINEER, RESEARCHER, GENERALIST.
