---
name: Bounded Revision Loop
slug: line-revision-loop
description: Draft, review, and revise against an explicit verdict with a hard pass ceiling.
...
## Pattern
A writer drafts; an independent reviewer returns APPROVED or a concrete correction list; revision stops after at most three passes.
